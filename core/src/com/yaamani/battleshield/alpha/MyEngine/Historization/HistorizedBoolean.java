...
public class HistorizedBoolean {

    private static final String TAG = HistorizedBoolean.class.getSimpleName();
     ...
     * @throws
     */
    public HistorizedBoolean(int theNumOfValuesToBeRecorded) {
        ...
        history = new boolean[theNumOfValuesToBeRecorded];
    }
     ...
     * @param initialValue
     */
    public HistorizedBoolean(int theNumOfValuesToBeRecorded, boolean initialValue) {
    ...
    /**
     * {@link HistorizedBoolean#getValue(int)}.
     * @return getValue(0).
     */
    ...
    private void appendToHistory(boolean value) {
        currentIndex++;
