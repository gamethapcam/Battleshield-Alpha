...
public class HistorizedChar {

    private static final String TAG = HistorizedChar.class.getSimpleName();
     ...
     * @throws
     */
    public HistorizedChar(int theNumOfValuesToBeRecorded) {
        ...
        history = new char[theNumOfValuesToBeRecorded];
    }
     ...
     * @param initialValue
     */
    public HistorizedChar(int theNumOfValuesToBeRecorded, char initialValue) {
    ...
    /**
     * {@link HistorizedChar#getValue(int)}.
     * @return getValue(0).
     */
    ...
    private void appendToHistory(char value) {
        currentIndex++;
