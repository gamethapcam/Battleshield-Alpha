...
public class HistorizedInteger {

    private static final String TAG = HistorizedInteger.class.getSimpleName();
     ...
     * @throws
     */
    public HistorizedInteger(int theNumOfValuesToBeRecorded) {
        ...
        history = new int[theNumOfValuesToBeRecorded];
    }
     ...
     * @param initialValue
     */
    public HistorizedInteger(int theNumOfValuesToBeRecorded, int initialValue) {
    ...
    /**
     * {@link HistorizedInteger#getValue(int)}.
     * @return getValue(0).
     */
    public int getValue() {
        return getValue(0);
